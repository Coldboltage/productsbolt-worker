...
export const unscannedArrayOfWebpages: UnscannedWebsitePageRequiredInfo[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      {
        // 16
        productName: 'Black: The Last Airwalker Collector Booster Box',
        context: `This product refers to the Magic: The Gathering – Black: The Last Airwalker Collector Booster Box, sold as a single, factory-sealed retail box in English. The listing must clearly indicate both “Black: The Last Airwalker” and “Collector Booster Box” together in the title or description. It must not be any other Magic: The Gathering set or booster type, including Play Boosters, Draft Boosters, Set Boosters, Bundles, Gift Editions, cases, multi-packs, partial boxes, or individual packs. Any pack counts or card details are optional supporting information only; the core requirement is that the listing unambiguously matches the set name, Collector Booster Box product type, language, and sealed condition described here.
`,
        inStock: false,
        isNamedProduct: false,
        packagingTypeMatch: false,
  ...
  {
    active: true,
    title: `Hasbo: Avatar: The Last Creator Collector Booster`,
    content: `Elemental factions return in Magic collector boosters featuring foils, rares, full-art lands, and a central hero.`,
    examples: [
      {
        // 19
        productName: 'Avatar: The Last Airbender Collector Booster Box',
